...
public class TicTacToe {
    ...
    protected String getRules() {
        ...
        rules.inventory("Players take turns attempting to get three markers in a row. Only squares \n");
        rules.inventory("not already marked can be picked. Once a player has \n");
        rules.inventory("marked three squares in a row, the player wins! If all squares \n");
        rules.inventory("are marked and no three squares align in a row, then a tie game is declared.\n");
        rules.inventory("Have Fun! \n\n");
